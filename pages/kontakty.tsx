  ...
  return (
    <div>
      ...
      <div className={`${styles.staticPage} container`}>
        <StaticPagesMenu />
        <div
          className={`${styles.staticPageContent} ${styles.contactsContent}`}
        >
          <div>
            ...
            <div className={styles.staticPageInfo}>
              ...
              <div className={`${styles.staticPageText} ${styles.gray}`}>
                Звонок бесплатный
              </div>
              <div className={styles.staticPageText}>
                Специалисты клиентской поддержки принимают звонки с&nbsp;9:00
            ...
            <div className={styles.staticPageInfo}>
              ...
              <div className={styles.staticPageText}>
                143006&nbsp;Россия, Московская область, Одинцово, Внуковская
                улица, 9
              </div>
            </div>
            <div className={styles.staticPageInfo}>
              ...
              <div className={styles.staticPageText}>
                Россия, Московская область, Одинцово, Луговая улица, 10
              </div>
            </div>
            <div className={styles.staticPageInfo}>
              <div className={`${styles.staticPageText} ${styles.bold}`}>
              ...
              <div className={styles.staticPageText}>
                Наименование организации: ООО &laquo;Вобаза&raquo; ИНН/КПП
                6167198895/616701001&nbsp;ОГРН 1206100021863 Юридический адрес:
                344111, Ростовская обл., г. Ростов-на-Дону, ул. 50-летия
                Октября, д. 33/1, офис&nbsp;1
              </div>
            </div>
            <div className={styles.staticPageInfo}>
              <div className={`${styles.staticPageText} ${styles.bold}`}>
          ...
          <div>
            <div className={styles.staticPageInfo}>
              ...
              <div className={styles.staticPageText}>
                Если у&nbsp;вас возник вопрос&nbsp;&mdash; напишите нам
              </div>
