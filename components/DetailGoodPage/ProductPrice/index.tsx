...
const ProductPrice: FC<ProductPrice> = ({ className = '', price, list_price, beforeDiscountPrice }) => {
  ...
  return (
    <div className={containerClasses}>
      ...
      {beforeDiscountPrice && <div className={styles.priceOld}>{toNumberWithSpaces(beforeDiscountPrice)} ₽</div>}
      {list_price && (
